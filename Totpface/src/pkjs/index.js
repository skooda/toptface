...
Pebble.addEventListener('showConfiguration', function() {
  var html ='<html><body style="font-family:sans-serif;background:#111;color:#eee;padding:20px">' +
    '<h2>TOTP Secret</h2>' +
    '<p style="color:#aaa;font-size:13px">Base32 secret from your authenticator app</p>' +
    ...
    '<div id="e" style="color:red;display:none">Invalid secret (A-Z and 2-7 only)</div>' +
    '<button onclick="save()" style="width:100%;padding:14px;background:#1976D2;color:#fff;border:none;font-size:17px;margin-top:8px">Save to Watch</button>' +
